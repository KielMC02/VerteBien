namespace VerteBienV1.Migrations
{
    ...
    public partial class Creando_SP_Busca_Servicio : DbMigration
    {
        public override void Up()
        {
            //CreateStoredProcedure("Buscar_Servicio_Filtro2", x => new { dato = x.String(), sector = x.String() }, @"create procedure [dbo].[Buscar_Servicio2] (@dato varchar(100), @sector varchar(100))
            //as
            //begin
            ...
            //Sql(SP_Busca_Servicio.Buscar_Servicio_Filtro,);
        }
        
        public override void Down()
        {
            //DropStoredProcedure("Buscar_Servicio_Filtro2");
            //Sql(SP_Busca_Servicio.Borra_SP_Filtro);
        }
    }
}
